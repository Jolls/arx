...
-- Capabilities (BOM, etc.) are now encoded as BIT columns directly on part where needed.
-- Category labels are stored in part.category with a CHECK constraint. See part_number.sql.
