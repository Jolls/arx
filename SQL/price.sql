...
-- part_id FKs to part_number.id. supplier_id FKs to company.id.
...
ALTER TABLE dbo.price ADD CONSTRAINT FK_price_PN       FOREIGN KEY (part_id)     REFERENCES dbo.part_number (id);
