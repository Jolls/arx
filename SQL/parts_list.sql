...
CREATE TABLE bom (
  ...
  parent_part_id     INT            NOT NULL,           -- FK to PN.PNID (parent assembly).
  component_part_id  INT            NOT NULL,           -- FK to PN.PNID (component part).
...
ALTER TABLE dbo.bom ADD CONSTRAINT FK_bom_PN_parent    FOREIGN KEY (parent_part_id)    REFERENCES dbo.PN (PNID);
ALTER TABLE dbo.bom ADD CONSTRAINT FK_bom_PN_component FOREIGN KEY (component_part_id) REFERENCES dbo.PN (PNID);
