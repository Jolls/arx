...
-- parent_part_id is the PNID of the parent assembly (the thing being built).
-- component_part_id is the PNID of the component (the thing being used).
...
CREATE TABLE bom (
  ...
  parent_part_id     INT            NOT NULL,           -- FK to part_number.id (parent assembly).
  component_part_id  INT            NOT NULL,           -- FK to part_number.id (component part).
...
ALTER TABLE dbo.bom ADD CONSTRAINT FK_bom_PN_parent    FOREIGN KEY (parent_part_id)    REFERENCES dbo.part_number (id);
ALTER TABLE dbo.bom ADD CONSTRAINT FK_bom_PN_component FOREIGN KEY (component_part_id) REFERENCES dbo.part_number (id);
