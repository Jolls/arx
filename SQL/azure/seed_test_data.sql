...
BEGIN TRY
    ...
    -- rows are deleted.
    UPDATE dbo.contact SET company_id = NULL;
    ...
    UPDATE dbo.part SET default_supplier_id = NULL, price_id = NULL, primary_attachment_id = NULL;
    ...
    INSERT INTO dbo.part_attachment (id, part_id, file_name, category, part_revision, sort_order, comment, hash) VALUES
    ...
    SET IDENTITY_INSERT dbo.part_attachment ON;
    INSERT INTO dbo.part_attachment (id, part_id, file_name, category, part_revision, sort_order, comment, supplier_part_id, mfg_part_id, hash) VALUES
    ...
    INSERT INTO dbo.form_row (id, form_id, revision, type, parameter, specification, spec_units, spec_min, spec_nom, spec_max, pf_type, instrument_types, archived, format, default_result, hide_formula, updated_at, granularity) VALUES
        ...
        (6108, 6001, 1, 0, 'Retest Voltage Check',  'Re-measure output ({6102} at first test)', 'V', '4.75', NULL, '5.25', 'range', NULL, 0, '0.00', '=min(max({6102},4.75),5.25)', '{record.type}!=Re-Test', '2020-01-01T00:00:00', 'unit'); -- only shown on Re-Test records; default_result clamps the prior reading to this step's spec range
