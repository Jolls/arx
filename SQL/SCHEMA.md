...
| 8201-8299 | `build` | One past build of assembly 3005 (#675); component-issue/output-receipt ledger rows deliberately not seeded so the calibrated `inventory_transaction` balances stay intact |
| 8301-8399 | `lot` | Lot control (#676): purchased lot 8301 of part 3007 (`lot_number` = PO number 5003, vendor lot captured, → `po_line` 5504) and manufactured lot 8302 of sub-assembly 3012. Parts 3007 + 3012 are `is_lot_tracked = 1`; 3005 is left un-tracked so the #675 build test is unaffected |
