-- part_attachment: File and URL attachments linked to a Part Number (PN).
-- Each row is one attachment. part_id links to PN.PNID.
...
CREATE TABLE part_attachment (
  ...
  part_id        INT NOT NULL  REFERENCES dbo.PN (PNID),  -- FK to PN.PNID.
