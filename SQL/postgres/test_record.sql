...
DROP TABLE IF EXISTS test_record CASCADE;
...
CREATE TABLE test_record (
  ...
  comments               TEXT,
  instrument_type        VARCHAR(100),                      -- Matched against test_definition.instrument_types.
...
-- ALTER TABLE test_record ADD CONSTRAINT FK_test_record_form FOREIGN KEY (form_id) REFERENCES form (id);
