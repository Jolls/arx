...
-- SUNumOfLNKs on company is a denormalized count maintained by a trigger on
-- SQL Server; that trigger is NOT yet ported to Postgres (see SQL/postgres/README.md).
