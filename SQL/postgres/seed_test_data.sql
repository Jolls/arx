...
BEGIN;
    ...
    INSERT INTO users (id, username, display_name, password_hash, is_active, can_approve_po, can_approve_records, is_admin, default_po_contact_id, default_po_receiver_id, accent_color, updated_at) VALUES
        (8001, 'admin',  'Admin User',  '$2a$10$0mUf8G9KxL6jGVWpUJZnaO40arOpPIqW09xqPyiyqnrBCR/VxffQe', TRUE, TRUE, TRUE, TRUE, 2005, 1003, 'teal', '2020-01-01T00:00:00'),
        (8002, 'tester', 'Test User',   '$2a$10$B29vUdQg85rwb53HIcltUuhdIb17PrSSVF32tJNJ/TQ1JyHvVYer2', TRUE, FALSE, FALSE, FALSE, NULL, NULL, NULL, '2020-01-01T00:00:00');
    ...
    -- 6. Parts
    -- ============================================================
    INSERT INTO part (id, part_number, category, revision, title, release_status, is_active, uom_id, current_cost, default_supplier_id, last_rollup_cost, last_rollup_at) VALUES
    ...
    INSERT INTO lot (id, part_id, lot_number, lot_description, vendor_lot_number, source, po_line_id, created_at, is_active) VALUES
        (8301, 3007, '8301', 'PO 5003',                          'SS304-LOT-0088', 'purchase', 5504, '2026-05-15T00:00:00', TRUE),
        (8302, 3012, '8302', 'Build #8202',                      NULL,             'build',    NULL, '2026-05-25T00:00:00', TRUE),
        (8303, 3007, '8303', 'Cycle count - unlabeled found lot', NULL,            'adjust',   NULL, '2026-05-22T00:00:00', TRUE),
        (8306, 3013, '8306', 'Build #8203',                       NULL,            'build',    NULL, '2026-05-30T00:00:00', TRUE);
